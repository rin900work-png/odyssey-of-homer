...
SONG_QUERIES = {
    1: ['Guerin Aeneas telling Dido misfortunes Troy', 'Rubens Neptune calms the storm Quos Ego',
        'Tiepolo Aeneas Dido banquet', 'Guerin Cupid disguised as Ascanius Dido',
        'Rubens Juno and Aeolus', 'Aeneas shipwreck storm painting'],
    ...
    9: ['Rude Nisus Euryale sculpture Louvre', 'Nisus Euryalus marble sculpture',
        'Death of Nisus Euryalus Virgil painting'],
    10: ['Death of Pallas painting Aeneid', 'Mezentius Lausus painting', 'Aeneas battle Turnus painting',
         'Aeneas kills Mezentius painting', 'Death of Lausus painting'],
...
CHAR_QUERIES = {
    ...
    "Эвандр и Паллант": ['Evander Pallas Aeneid painting', 'Pallas son of Evander painting',
                         'Death of Pallas Turnus', 'Hospitality of Evander painting',
                         'Evander Aeneas Pallanteum painting'],
    "Низ и Эвриал": ['Rude Nisus Euryale sculpture Louvre', 'Nisus Euryalus marble sculpture',
                     'Nisus and Euryalus mythology painting'],
    "Камилла": ['Camilla queen of the Volsci painting', 'Camilla Aeneid warrior painting',
                'Camilla shot by Arruns painting', 'Camilla Volscian warrior painting'],
    "Мезенций": ['Mezentius Aeneid painting', 'Death of Mezentius painting', 'Mezentius Lausus painting',
                 'Mezentius wounded Aeneas painting', 'Etruscan tyrant Mezentius painting'],
